...
<body>
	Complaint
	<i class="fa fa-2x fa-fire-extinguisher"></i><h2 class="text-muted m-l-5">민원접수 수정</h2>
	<div class="panel panel-inverse" data-sortable-id="index-4">
		...
		<div class="panel-footer text-right">
			<a href="javascript:;" class="btn btn-white btn-sm">삭제하기</a> <a
				href="javascript:;" class="btn btn-primary btn-sm m-l-5">수정완료</a>
		</div>
	</div>
