...
<div id="header" class="header navbar navbar-default navbar-fixed-top">
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<a href="${contextPath}/resident/main" class="navbar-brand"><img style="position: absolute; width: 110px; top: 8px; left: 14px;" src="${contextPath}/resources/images/onpart (1).png" alt="" /> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | V i-F i</a>
