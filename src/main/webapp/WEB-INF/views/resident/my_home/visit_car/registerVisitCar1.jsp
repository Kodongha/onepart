...
<head>
	...
	<link href="${contextPath}/resources/plugins/ionRangeSlider/css/ion.rangeSlider.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/ionRangeSlider/css/ion.rangeSlider.skinNice.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/password-indicator/css/password-indicator.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/bootstrap-combobox/css/bootstrap-combobox.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet" />
	<link href="${contextPath}/resources/plugins/jquery-tag-it/css/jquery.tagit.css" rel="stylesheet" />
    <link href="${contextPath}/resources/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" />
    <link href="${contextPath}/resources/plugins/select2/dist/css/select2.min.css" rel="stylesheet" />
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							<a href="javascript:;"><img src="${contextPath}/resources/img/user-13.jpg" alt="" /></a>
						</div>
						<div class="info">
							Sean Ngu
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span> Bootstrap Date Range Picker</h4>
                        </div>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-2">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span> Select2</h4>
                        </div>
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered">
								<div class="form-group">
