...
<div style="width:95%; margin:0 auto">
	...
	<table style="width:95%">
		<tr>
			...
			<td style="width:15%">
				 <a class="btn btn-white" style="width:100%" id="sendMessageResident">문자발송</a>
			</td>
			<td style="width:1%"></td>
			<td style="width:15%">
				<a class="btn btn-white" style="width:100%" id="offlineVote">오프라인 투표모드</a>
			</td>
		</tr>
	</table>
	<hr>
	...
	<table style="width:95%">
		<tr>
			...
			<td><div><h5>투표기간</h5></div></td>
			<td><div><h5>36%</h5></div></td>
			<td style="width:5%"></td>
		</tr>
		<tr>
