...
<div style="width:95%; margin:0 auto">
	...
	<table style="width:95%">
		<tr>
			...
			<td style="width:15%">
				 <a class="btn btn-white" style="width:100%" id="candidateRegistration">후보등록 요청</a>
			</td>
			<td style="width:1%"></td>
			<td style="width:15%">
				<a class="btn btn-white" style="width:100%" id="candidateApply">후보 신청서 관리</a>
			</td>
		</tr>
	</table>
	<hr>
