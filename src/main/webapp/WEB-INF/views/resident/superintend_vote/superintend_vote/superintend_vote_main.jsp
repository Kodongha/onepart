						...
						<tr>
							<td>
								<div class="form-group">
                                       ...
                                       <select class="form-control input-sm" id="conChoiceC" style="height:30px;">
						...
						<tr>
							<td>
								<div class="form-group">
                                       ...
                                       <select class="form-control input-sm" id="" style="height:30px;">
				...
				<div>
						...
						<tr style="margin-bottom: 15px;">
							<td>
								<div class="form-group" style="margin-bottom: 45px;">
                                       ...
                                       <input type="text" id="testDatepicker" class="form-control pull-right" placeholder="클릭하세요" style="width:100%; height:100%">
                                   </div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<div class="form-group">
                                       ...
                                       <textarea class="form-control" placeholder="Textarea" rows="5" style="margin: 0px 1px 0px 0px; width:100%; height: 141px; resize:none;"></textarea>
                                   </div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group" id="conDiv" style="opacity:0;">
										<c:forEach var="month" begin="101" end="105">
                                           		&nbsp;&nbsp;&nbsp;<input type="checkbox"><label for="exampleInputEmail1">&nbsp;&nbsp;&nbsp;${ month }동</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         </c:forEach>
                                   </div>
							</td>
						</tr>
						...
						<tr>
							<td>
								<div class="form-group" style="width:30%">
                                       <a href="#modal-dialog_test" data-toggle="modal" class="btn btn-default" style="width:100%">새 후보 추가</a>
                                   </div>
							</td>
						</tr>
					</table>
					...
					<table style="width:90%; margin:0 auto;">
						<tr>
							<td>
								<div class="form-group">
                                       <a class="btn btn-success" style="width: 100%" id="candidateApply">등록</a>
                                   </div>
							</td>
							<td style="width:5%"></td>
							<td>
								<div class="form-group">
                                       <a class="btn btn-danger" style="width: 100%" id="candidateApply">취소</a>
                                   </div>
							</td>
						</tr>
					</table>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal" onclick="">후보등록</a>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    /* 투표권 부여내역에 따른 checkbox 변경function */
    $(function(){
