...
<body>
	...
	<script>
		$(document).ready(function() {
			...
			$("#menuComplaint").data("menu-url", "/onepart/manager/menuComplaint"); 	// 공지사항
			$("#menuEmployeeManage").data("menu-url", "/onepart/resident/employeeManage");		// 투표
			$("#menuSurvey").data("menu-url", "/onepart/resident/menuSurvey");	// 설문조사
			$("#menuEvent").data("menu-url", "/onepart/resident/menuEvent");	// 관리비
			$("#menuVisitCar").data("menu-url", "/onepart/resident/menuVisitCar");				// 방문차량
			$("#menuFacility").data("menu-url", "/onepart/resident/menuFacility");	// 오픈채팅
			$("#menuMaintenanceCost").data("menu-url", "/onepart/resident/menuMaintenanceCost");					// 이벤트 신청 및 조회
			$("#menuNotice").data("menu-url", "/onepart/resident/menuNotice");	// 시설물 예약
			$("#menuSurvey").data("menu-url", "/onepart/resident/menuSurvey");		// 회의 참관
			$("#menuVisitCar").data("menu-url", "/onepart/resident/menuComplaint");					// 민원접수
