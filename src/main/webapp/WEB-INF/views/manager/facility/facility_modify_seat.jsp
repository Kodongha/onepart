			...
			<div align="center" style="background:white">
				...
				<table style="width:90%">
					<tr>
						...
						<td colspan="3"><input type="text" class="form-control" placeholder="Default input" value="${ rs.facNm }" id="facNm" name="facNm"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3"><input type="text" class="form-control" placeholder="Default input" value="${ rs.facPosition }" id="facPosition" name="facPosition"></td>
					</tr>
					<tr>
						<td style="height:10px"></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3"><input type="text" class="form-control" placeholder="Default input" value="${ rs.facDefaultFee }" id="facDefaultFee" name="facDefaultFee"></td>
					</tr>
					<tr>
						<td style="height:10px"></td>
					</tr>
					<tr>
						...
						<td colspan="3"><input type="text" class="form-control" placeholder="Default input" value="${ rs.facMaxHead }" id="facMaxHead" name="facMaxHead"></td>
					</tr>
					<tr>
						<td style="height:10px"></td>
					</tr>
					<tr>
						...
						<td colspan="3"><input type="text" class="form-control" placeholder="Default input" value="${ rs.facSquareMeasure }" id="facSquareMeasure" name="facSquareMeasure"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="4">
							<textarea id="facDetailInfo" name="facDetailInfo" class="form-control" placeholder="Textarea" rows="5" style="margin: 0px 1px 0px 0px; width:100%; height: 141px;">${ rs.facDetailInfo }</textarea>
						</td>
					</tr>
					<tr>
						<td style="height:15px"></td>
					...
					<tr>
						<td colspan="4">
							<textarea id="facRsrvInfo" name="facRsrvInfo" class="form-control" placeholder="Textarea" rows="5" style="margin: 0px 1px 0px 0px; width:100%; height: 141px;">${ rs.facRsrvInfo }</textarea>
						</td>
					</tr>
					<tr>
						<td style="height:15px"></td>
					...
					<tr>
						<td colspan="4">
							<textarea id="facUseInfo" name="facUseInfo" class="form-control" placeholder="Textarea" rows="5" style="margin: 0px 1px 0px 0px; width:100%; height: 141px;">${ rs.facUseInfo }</textarea>
						</td>
					</tr>
					<tr>
						<td style="height:15px"></td>
	...
	$(function(){
		...
		$("#btnSubmit").click(function (event) {
	        ...
	        $.ajax({
	            ...
	            url: "/onepart/manager/update_facility_seat",
	            data: data,
	            processData: false,
	            contentType: false,
	            cache: false,
