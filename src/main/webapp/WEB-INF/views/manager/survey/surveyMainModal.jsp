	...
	$(function(){
		...
		$('select[name="surveyType"]').change(function(){
			...
			// 객관식
				...
				var $buttonAddOptionBtn = $('<button>', {type:'button', class:'btn btn-success btn-block', name:'addOption'});
		...
		// 옵션 추가
		$("button[name='addOption']").on('click', function(){
			console.log("클릭했다 멍청아!!!");
		});
	});
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="defaultTemplate">
						<div class="col-md-9">
							<input type="text" class="form-control" placeholder="설문조사 문제의 제목을 입력해주세요.">
						</div>
						<div class="col-md-3">
